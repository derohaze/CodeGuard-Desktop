...
- reject weak, duplicate, or speculative claims
...
- reject any claim that does not provide all of the following: source hint, sink hint, path hint, and evidence lines
