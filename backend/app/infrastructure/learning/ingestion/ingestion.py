...
from app.infrastructure.learning.ingestion.external_parsers import (
...
from app.infrastructure.learning.common.normalization import normalize_external_item
