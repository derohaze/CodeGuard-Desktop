...
from app.infrastructure.services.patch.patch_applier import apply_patch_locally
from app.infrastructure.services.patch.patch_checkpointing import append_checkpoint, create_patch_checkpoint
from app.infrastructure.services.patch.patch_validator import validate_patch_application
from app.infrastructure.services.patch.post_fix_verifier import verify_applied_patch
from app.infrastructure.services.remediation.decision_summary import (
...
from app.infrastructure.services.remediation.remediation_session_state import build_post_remediation_updates
